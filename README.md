...
1. Hacer click en el botón "New" ubicado en la parte inferior derecha. <br/>![new](02.jpg)
1. Seleccionar "Blank Experiment".
## Paso 3 - Diseñar el Experimento
1. En la parte izquierda encontrará el panel de herramientas. <br/>![tools](03.jpg)
	* Aquí verá todas los elementos que puede arrastrar al Área de Diseño del experimento.
1. Arrastre al experimento el DataSet de ejemplo "Iris Two Class Data" <br/>![data](06.jpg) 
...
1. Arrastre al experimento el componente "Split Data", ubicado en la categoria "Data Transformation" / "Sample and Split" <br/>![split](07.jpg)
...
1. Arrastre al área de diseño el componente "Train Model" ubicado en la categoria "Machine Learning" / "Train"
	...
	* Finalice haciendo click en el boton "Check" de la parte inferior. <br/>![configtrain](04.jpg)
1. Arrastre al área de diseño el componente "Two-Class Neural Network" desde el panel de herramientas ubicado en la categoria "Machine Learning" / "Initialize Model" / "Clasification" <br/>![netural](05.jpg)
...
1. Haga click en el botón "Run" <br />![run](09.jpg)
...
1. Haga click en el botón "Set Up Web Service" y seleccione la opción "Predictive Web Sercice [Recommended]" <br />![webservice](10.jpg)
	* El Modelo se trasnformará en un servicio con entradas y salidas, verá en la parte superior dos pestañas, donde podrá editar el modelo y republicarlo. <br />![webservice2](11.jpg)
1. Ejecute el experimento configurado como servicio web
	* Haga click en el boton "Run" <br />![run2](09.jpg)
...
1. Haga click en el botón "Test" <br />![test](12.jpg)
1. Ingrese los datos en la ventana para realizar la clasificación en la ventana <br />![test2](13.jpg)
...
1. Al ejecutar cada una de las pruebas verá en la parte inferior una barra con el resultado de la ejecución <br />![result2](14.jpg)
